...
public struct Configuration
{
    ...
    public bool GenerateCQRSTypes { get; set; }
}
...
public class RpcMediatorIncrementalGenerator : IIncrementalGenerator
{
    ...
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        ...
        context.RegisterSourceOutput(configurationProvider, GenerateBaseTypes!);
    ...
    private static Configuration ExtractConfiguration(AnalyzerConfigOptionsProvider s, CancellationToken _ = default)
    {
        ...
        s.GlobalOptions.TryGetValue("build_property.MediatR_GenerateCQRSTypes", out var generateCqrsTypes);

        return new Configuration { EnableCQRS = enableCqrs is not "false", GenerateCQRSTypes = generateCqrsTypes is not "false" };
    }
...
{sb}
    ...
    private static void GenerateBaseTypes(SourceProductionContext productionContext, Configuration configuration)
    {
        if (configuration.EnableCQRS && configuration.GenerateCQRSTypes)
            productionContext.AddSource("MediatR.g.cs", @"// <auto-generated />
